...
#ifdef	TTY_ALTERASE
#define	TIOCSALTERA	_IOW(t, 99, char)	/* set alternate erase char */
#define	TIOCGALTERA	_IOR(t, 98, char)	/* get alternate erase char */
#endif	TTY_ALTERASE
...
#ifdef	IPSUBNET
#define	SIOCSIPSUBWIDTH	_IOWR(i, 21, struct ifreq)	/* set IP subnet width */
#define	SIOCGIPSUBWIDTH	_IOWR(i, 22, struct ifreq)	/* get IP subnet width */
#endif	IPSUBNET
