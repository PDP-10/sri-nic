...
#define	SIGNUMMASK	  07777777777	/* to extract pure signal number */
#define	SIGDODEFER	0200000000000	/* do SIG_HLD after tripping int */
#define	SIGDOPAUSE	0100000000000	/* do pause after setting action */
#define	SIGDORTI	 040000000000	/* do ret+rti after setting action */

#define	SIGISDEFER(x)	(((int)(x) & SIGDODEFER) != 0)
#define	SIGUNDEFER(x)	(int (*)())((int)(x) &~ SIGDODEFER)
#define	DEFERSIG(x)	(int (*)())((int)(x) | SIGDODEFER)
#endif
