/* GETPW.C - Get user name from user ID.
...
#else
#error getpw() not supported for this system.
#endif
}
...
#endif
#else
#error getpwuid() not supported for this system.
#endif
    return &pwd;
}
...
#else
#error getpwnam() not supported for this system.
#endif
    return NULL;
}
