/* CTYPE.C - Character processing facility table
 *	Copyright (C) 1985 by Ken Harrenstien, SRI International
 *
 *	This table, plus ctype.h, implements the facilities described
...
#include "c-env.h"		/* For char size */
#include "ctype.h"

/* _CTOIN - Implements TOINT(c) facility. */
int
_ctoin(c)
char c;
{
...
/* _CTOLO - Implements TOLOWER(c) facility */
int
_ctolo(c)
char c;
...
/* _CTOUP - Implements TOUPPER(c) facility */
int
_ctoup(c)
char c;
