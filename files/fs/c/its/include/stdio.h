...
#define _SIOF_IMAGE	02000000	/* 'I' forced image mode open (on ITS) */
#define _SIOF_NO_IMAGE	04000000	/* 'I-' forced image mode open (on ITS) */
/*
...
#if SYS_ITS
#define SYS_OPEN	16	/* we guarantee this many files open at once */
#else
