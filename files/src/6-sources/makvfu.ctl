...
!
!
! FUNCTION:	THIS CONTROL FILE BUILDS MAKVFU FROM ITS BASIC
...
!
@VDIRECT SYS:MONSYM.UNV,SYS:MACSYM.UNV,SYS:MACRO.EXE,SYS:CREF.EXE,SYS:LINK.EXE,MAKVFU.MAC,
@CHECKSUM SEQ
@
...
@INFORMATION VERSION
!
@COMPILE /CREF MAKVFU.MAC
!
;SM	@R CREF
;SM	*FOO:MAKVFU.LST=MAKVFU.CRF
!
@LOAD MAKVFU
!
@SAVE MAKVFU
