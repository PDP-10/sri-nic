...
!
WORK::
@DEFINE SRCDX: DSK:, DX2:, DX1A:
@DEFINE SRCDL: DSK:, DL2:, DL1A:
@DEFINE SRCDT: DSK:, DT2:, DT1A:
@DEFINE DSTDL: DSK:
@DEFINE DSTDT: DSK:
@DEFINE DSTDX: DSK:
!  ALU-FTS-DIU.CMD defines XP1A:, DP1A:, etc...
@take lang:<data-interchange.alu>alu-fts-diu.cmd
@GOTO COMBIN

MASTER::
@DEFINE SRCDX: DX2:, DX1A:
@DEFINE SRCDL: DL2:, DL1A:
@DEFINE SRCDT: DT2:, DT1A:
@DEFINE DSTDL: DL2:
@DEFINE DSTDT: DT2:
@DEFINE DSTDX: DX2:
