...
RUN <HERMES>$HERMES.SYSG-T20-4500
<HERMES>$HERMES.INIT-T20-4500
DESCRIBE HLP:HERMES.DESSTR
HELP HLP:HERMES.HLPSTR
EXEC SYSTEM:EXEC.EXE
;WE PS:<HERMES>WE.EXE
mailer sys:dmailr.exe
ENCRYPTION
MMAILER-FORM
ADDRESS-CHECK
...
;the default filename, PS:<SYSTEM>MAILBOX.EXE, exists.
GO
HERMES.EXE
