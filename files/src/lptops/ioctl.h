...
/* Utah locals, from 64 on up */
#define TIOCSWID	(('t'<<8)|64)	/* Set terminal width */
#define TIOCGWID	(('t'<<8)|65)	/* Get terminal width */
#define TIOCSSTAT	(('t'<<8)|66)	/* Set proc-stats char */
#define TIOCGSTAT	(('t'<<8)|67)	/* Get proc-stats char */
