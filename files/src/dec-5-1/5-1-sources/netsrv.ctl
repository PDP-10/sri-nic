...
!
! FUNCTION:	THIS CONTROL FILE BUILD NETSRV FROM ITS BASIC
...
!
@VDIRECT SYS:MACRO.EXE,SYS:LINK.EXE,SYS:CREF.EXE,NETSRV.MAC,
@CHECKSUM SEQ
@
...
!
@NOERROR
@COMPILE /COMPILE /CREF NETSRV.MAC
!
@R CREF
*FOO:NETSRV.LST=NETSRV.CRF
!
@LOAD NETSRV
!
@SAVE NETSRV.EXE
