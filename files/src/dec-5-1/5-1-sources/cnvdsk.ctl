...
!
! FUNCTION:	THIS CONTROL FILE BUILDS CNVDSK FROM ITS BASIC 
...
!
@VDIRECT SYS:MACRO.EXE,SYS:LINK.EXE,SYS:CREF.EXE,CNVDSK.MAC,
@CHECKSUM SEQ
@
...
@INFORMATION VERSION
!
@COMPILE /CREF CNVDSK.MAC
!
@R CREF
*FOO:CNVDSK.LST=CNVDSK.CRF
!
@LOAD CNVDSK
!
@SAVE CNVDSK
