...
!
! FUNCTION:	THIS CONTROL FILE BUILDS MONSYM FROM ITS BASIC
!		SOURCES.  THE FILES NEEDED FOR ASSEMBLING AND
!		LOADING MONSYM ARE FOUND IN THE DIRECTORY
!		<V-SOURCES>.
!
!
