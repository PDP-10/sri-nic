...
!
! FUNCTION:	THIS CONTROL FILE BUILDS MOUNTR FROM ITS BASIC 
...
!
@VDIRECT SYS:MACRO.EXE,SYS:LINK.EXE,SYS:CREF.EXE,SYS:SERCOD.UNV,MOUNTR.MAC,
@CHECKSUM SEQ
@
@VDIRECT SYS:MONSYM.UNV,SYS:MACSYM.UNV,SYS:MACREL.REL,SYS:PA1050.EXE,
@CHECKSUM SEQ
@
@VDIRECT SYS:ACTSYM.UNV,SYS:GLXMAC.UNV,SYS:QSRMAC.UNV,SYS:ORNMAC.UNV,
@CHECKSUM SEQ
@
@RUN SYS:MACRO
@INFORMATION VERSION
...
@INFORMATION VERSION
!
@COMPILE /CREF MOUNTR.MAC
!
@R CREF
*FOO:MOUNTR.LST=MOUNTR.CRF
!
@LOAD MOUNTR
!
@SAVE MOUNTR
