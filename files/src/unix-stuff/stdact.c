...
int cmpact(), pcmact(), hlpact(), cfmact(), delact();
...
int (*(stdact[128]))() = {
    ...
    bsact,  NULL,   cfmact, NULL,   cfmact, cfmact, NULL,   NULL,
    NULL,   NULL,   fixact, NULL,   NULL,   begact, quoact, wrdact,
...
int deferred,flags;
{
  ...
  if (cmcsb._cmflg2 & CM_NIN) { /* no indirections allowed or one */
					/* current? */
