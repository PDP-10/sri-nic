...
! directory) compile of the DIL user interface routines (stored on DL:).
!
...
!
WORK::
@DEFINE SRC: DSK:, DL2:, DL1A:, DX2:, dx1A:
@DEFINE DSK: DSK:, DL2:, DL1A:, DX2:, dx1A:
!
![%O'133'] [%O'61'] [%O'55'] [%O'45'] Make DOC, HLP, and BWR files
@NEW:RUNOFF                             ! [%O'72'] [%O'45']	
...
MASTER::
@DEFINE SRC: DL2:, DL1A:, DX2:, dx1A:
@define dsk: DL2:, DL1A:, DX2:, DX1A:
@connect DL2:
!
![%O'133'] [%O'61'] [%O'55'] [%O'45'] Make DOC, HLP, and BWR files
@NEW:RUNOFF                             ! [%O'72'] [%O'45']	
