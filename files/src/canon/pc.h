...
# define SPclose	5		/* Secs to idle after closing */
# define SPgiveUp	90		/* Secs before giving up */
...
/* # define QuotedChars BOPchar,EOPchar,QuoteChar,CtrlS,CtrlSs,
	CtrlQ ,CtrlQ */
# define QuotedChars BOPchar,EOPchar,QuoteChar
