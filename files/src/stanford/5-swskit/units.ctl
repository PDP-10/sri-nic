...
!SYSTEMS.
!
! FUNCTION:	THIS CONTROL FILE BUILDS UNITS FROM ITS BASIC 
...
!
@VDIRECT SYS:MACRO.EXE,SYS:LINK.EXE,SYS:CREF.EXE,UNITS.MAC,
@CHECKSUM SEQ
@
...
@INFORMATION VERSION
!
@COMPILE /CREF/COMPILE UNITS.MAC
!
@R CREF
*FOO:UNITS.LST=UNITS.CRF
!
@LOAD UNITS
!
@SAVE UNITS
